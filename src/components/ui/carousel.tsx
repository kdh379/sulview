...
const CarouselDotButton = ({ className }: { className?: string }) => {
...
export { Carousel, type CarouselApi, CarouselContent, CarouselDotButton, CarouselItem, CarouselNext, CarouselPrevious };
