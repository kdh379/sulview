  ...
  return (
    <div className="space-y-4">
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex-1">
            ...
            <FormControl>
              <Input {...field} className="text-xl font-semibold" placeholder="와일드 터키" />
            </FormControl>
          </FormItem>
        )}
      />
          ...
          <FormItem>
            ...
            <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex flex-col space-y-1">
              <FormItem className="flex items-center space-x-3 space-y-0">
                ...
                <FormLabel className="font-normal" message={false}>
                  증류소 병입
                </FormLabel>
              </FormItem>
              <FormItem className="flex items-center space-x-3 space-y-0">
      ...
      <div>
        ...
        <Button variant="outline" size="sm" className="mt-2" onClick={() => append({ value: "" })}>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormMessage />
            <FormControl>
              <Input {...field} placeholder="900818" />
            </FormControl>
          </FormItem>
        )}
      />
